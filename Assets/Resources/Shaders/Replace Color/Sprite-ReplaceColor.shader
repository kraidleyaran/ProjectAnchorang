...
Shader "Sprites/ReplaceColor" {
	Properties
	{
		...
		[PerRendererData]_ColorIn("Color to replace", Color) = (1,1,1,1)
		[PerRendererData]_Color1out("Replace color", Color) = (1,1,1,1)
		[PerRendererData]_ColorThreshold("Color Threshold", Float) = 0
		[PerRendererData]_Color2out("Color for other areas", Color) = (1,1,1,1)
	}
	SubShader
	{
		Tags
